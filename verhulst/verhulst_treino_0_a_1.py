...
x_full = torch.linspace(0, 10, 1000).reshape(-1, 1)
...
plt.plot(x_full, y_pred, '--', label="Neural Network — trained on [0, 1]")
plt.xlabel("t")
plt.ylabel("y(t)")
plt.title("Supervised training on [0, 1] + Initial Condition")
plt.legend()
plt.grid(True)
...
plt.tight_layout()
plt.savefig("grafico_treino_0_a_1.png")
plt.show()