...
x_sup = torch.linspace(0, 2.0, 3000).reshape(-1, 1)
y_sup = verhulst_solution(x_sup, y0, r, K)
...
plt.plot(x_full, y_pred, '--', label="Neural Network — trained on [0, 2]")
plt.xlabel("t")
plt.ylabel("y(t)")
plt.title("Supervised training on [0, 2] + Initial Condition")
plt.legend()
plt.grid(True)
